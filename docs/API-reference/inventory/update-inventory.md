...
sidebar_label: Update Inventory Levels
sidebar_position: 2
description: "POST /inventory — set the stock level of one or more products in a SalesPlay shop."
---
...
**POST /inventory** — set the stock level of one or more products in a SalesPlay shop. Send parameters as a JSON request body (`inventory_levels`). Requires a Bearer token in the `Authorization` header. Base URL: `https://api.salesplaypos.com/v1.0`.



<div className="api-endpoint"><span className="api-badge api-badge--post">POST</span><code>https://api.salesplaypos.com/v1.0/inventory</code></div>
...
|---|---|---|
| `inventory_levels` | array[object] | List of inventory updates |
...
| Name | Type | Description |
|---|---|---|
| `shop_id` | string | The ID of the shop Example: `UnB1REl4LzZQc1dxMllnc2J3R0lpQT09` |
| `product_id` | string | The ID of the product Example: `QWhxek54UkQ3eTArdml2d1NkSDVnUT05` |
| `in_stock` | number | Number of units available in stock Example: `5` |
...
```bash
curl -X POST "https://api.salesplaypos.com/v1.0/inventory" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
  "inventory_levels": [
    {
      "shop_id": "UnB1REl4LzZQc1dxMllnc2J3R0lpQT09",
      "product_id": "QWhxek54UkQ3eTArdml2d1NkSDVnUT05",
      "in_stock": 5
    }
  ]
}'
...
```javascript
const res = await fetch("https://api.salesplaypos.com/v1.0/inventory", {
  method: "POST",
  headers: {
...
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode({"inventory_levels": [{"shop_id": "UnB1REl4LzZQc1dxMllnc2J3R0lpQT09", "product_id": "QWhxek54UkQ3eTArdml2d1NkSDVnUT05", "in_stock": 5}]}));
...
```csharp
var request = new HttpRequestMessage(new HttpMethod("POST"), "https://api.salesplaypos.com/v1.0/inventory");
...
{
  "code": "SUCCESS",
  "details": "inventory successfully updated"
}
```
...
| Name | Type | Description |
|---|---|---|
| `code` | string | Status code Example: `SUCCESS` |
| `details` | string | Details about the operation Example: `inventory successfully updated` |
